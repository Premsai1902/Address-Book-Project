 ...
 * Description : Populates the address book with dummy contacts 
 *               for testing or demo purposes.
 ***************************************************************/

#include "contact.h"

// Dummy contact data for initialization
...
// Function to add dummy contacts to the address book
void populateAddressBook(AddressBook* addressBook)
{
    ...
    for (int i = 0; i < numDummyContacts && addressBook->contactCount < MAX_CONTACTS; ++i) {
        addressBook->contacts[addressBook->contactCount++] = dummyContacts[i]; // Add contact
    }
}
